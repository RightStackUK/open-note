 ...
 *
 * They live in core rather than in the desktop app because the import pipeline
 * writes the links as well as reading them: a note and its attachments are
 * placed in the same pass, and the reference between them has to be built
